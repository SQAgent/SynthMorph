...
output_path = '/home/shangqing/sqdata/project/sqagents/bin/CAE_FE/debug/'
file_path=output_path+'test.txt'
...
session.pngOptions.setValues(imageSize=(1200, 1610))
session.printToFile(fileName='model', format=PNG, canvasObjects=(
...
o3 = session.openOdb(name=output_path+Job_name+'.odb')
